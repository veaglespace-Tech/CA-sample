export function getPaymentSuccessEmailHtml({
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
      ...
      <p>Hi ${userName},</p>
      <p>Thank you for choosing Veagle Space Technology Pvt. Ltd.. Your payment for <strong>${serviceTitle}</strong> has been successfully processed and your registration is now complete.</p>
