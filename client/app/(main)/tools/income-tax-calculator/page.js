      ...
      <section className="relative -mt-8 z-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8">
            ...
            <div className="bg-white p-8 rounded-none shadow-sm border border-slate-200 transition-all duration-400 hover:-translate-y-1.5 hover:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.3),0_0_20px_rgba(210,144,82,0.1)] hover:border-gold/50">
              ...
              <div className="mb-8">
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4">
                  <label className={`relative flex items-center justify-center gap-2 p-4 rounded-none border-2 cursor-pointer transition-all ${regime === "new" ? "border-blue-500 bg-gold/10 text-gold" : "border-slate-200 text-slate-600 hover:bg-slate-50"}`}>
                    ...
                    {regime === "new" && <span className="absolute top-2 right-2 flex h-3 w-3"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span><span className="relative inline-flex rounded-full h-3 w-3 bg-gold/100"></span></span>}
                  </label>
                  <label className={`relative flex items-center justify-center gap-2 p-4 rounded-none border-2 cursor-pointer transition-all ${regime === "old" ? "border-blue-500 bg-gold/10 text-gold" : "border-slate-200 text-slate-600 hover:bg-slate-50"}`}>
                    <input type="radio" className="hidden" checked={regime === "old"} onChange={() => setRegime("old")} />
                    <span className="font-bold">Old Regime</span>
                  </label>
                </div>
                <div className="mt-4 p-4 rounded-sm bg-amber-50 border border-amber-100 text-xs font-semibold text-amber-700 flex items-start gap-2">
            ...
            {/* Results */}
            <div className="relative rounded-none bg-gradient-to-br from-indigo-900 to-slate-900 p-8 text-white shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-5 rounded-none shadow-lg border border-blue-500/50 relative overflow-hidden">
      ...
      <section className="mt-16 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-none p-8 sm:p-4 md:p-10 shadow-sm border border-slate-200 transition-all duration-400 hover:-translate-y-1.5 hover:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.3),0_0_20px_rgba(210,144,82,0.1)] hover:border-gold/50">
          ...
          <div className="prose prose-slate prose-lg max-w-none text-slate-600 font-medium leading-relaxed">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 my-8">
              <div className="bg-gold/10 p-6 rounded-none border border-blue-100">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-6 p-6 sm:p-8 bg-gradient-to-r from-slate-900 to-indigo-900 rounded-none shadow-xl border border-slate-800">
            <div>
            ...
            <Link href="/income-tax-return-filing" className="shrink-0 flex items-center gap-2 bg-white text-slate-900 px-6 py-3.5 rounded-sm font-bold hover:shadow-lg hover:shadow-white/20 transition-all active:scale-95">
