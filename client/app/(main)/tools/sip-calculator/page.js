      ...
      <section className="relative -mt-8 z-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8">
            ...
            <div className="bg-white p-8 rounded-none shadow-sm border border-slate-200 transition-all duration-400 hover:-translate-y-1.5 hover:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.3),0_0_20px_rgba(210,144,82,0.1)] hover:border-gold/50">
              ...
              <div className="mb-8">
                ...
                <div className="relative mb-6">
                  ...
                  <input 
                    type="number" 
                    className="w-full pl-12 pr-6 py-4 bg-slate-50 border-2 border-slate-200 rounded-none outline-none transition-all text-xl font-black text-slate-900 focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10" 
                ...
                <div>
                  ...
                  <div className="relative">
                    <input 
                      type="number" 
                      step="0.5" 
                      className="w-full px-6 py-4 bg-slate-50 border-2 border-slate-200 rounded-none outline-none transition-all text-xl font-black text-slate-900 focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10" 
            ...
            {/* Results */}
            <div className="relative rounded-none bg-gradient-to-br from-emerald-800 to-teal-900 p-8 text-white shadow-2xl overflow-hidden h-fit">
              ...
              <div className="relative z-10">
                ...
                <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-5 rounded-none shadow-lg border border-emerald-400/30 relative overflow-hidden mb-6">
