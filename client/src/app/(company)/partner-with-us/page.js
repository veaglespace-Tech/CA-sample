...
export const metadata = {
  title: "Partner With Us - Valuexpert",
  description: "Partner with Valuexpert Consulting Pvt Ltd to support businesses with legal, tax, compliance, registration, and advisory services.",
};
      ...
      <section className="vs-section vs-section-alt">
        <div className="vs-container vx-static-grid">
          <div>
            ...
            <p className="vx-muted">Valuexpert partners should help clients make confident decisions with clear documents, predictable timelines, and professional communication.</p>
          </div>
        ...
        <div className="vs-container">
          <div className="vs-refer">
            <div>
              ...
              <p>Share your profile, city, practice area, and collaboration idea with the Valuexpert team.</p>
            </div>
