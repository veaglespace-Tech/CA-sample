...
export const metadata = {
  ...
  description: "Create a standard Your Company Name user account.",
};
  ...
  return (
    <PublicOnlyRoute>
      <section className="vs-auth-shell">
        <div className="vs-auth-card vs-auth-card--wide grid grid-cols-1 md:grid-cols-5 p-0 overflow-hidden shadow-2xl">
          ...
          <div className="md:col-span-2 bg-gradient-to-br from-slate-50 to-indigo-50/50 p-8 md:p-12 border-b md:border-b-0 md:border-r border-slate-100 flex flex-col justify-center">
            ...
            <h1 className="text-3xl font-black text-slate-900 mt-2 mb-4 leading-tight">Register on Your Company Name</h1>
