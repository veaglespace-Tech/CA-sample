    ...
    <main className="vs-events-page">
      <section className="vs-page-hero vx-page-hero">
        <div className="vs-container">
          ...
          <p className="vs-hero-sub">Learn from Your Company Name advisors and stay ahead with curated legal, tax, registration, and compliance sessions.</p>
        </div>
      </section>
        ...
        <div className="vs-container">
          ...
          {isLoading ? (
            <div className="vx-empty-state">
              ...
              <p>Fetching the latest Your Company Name sessions.</p>
            </div>
          ) : !showFallback ? (
              ...
              {filteredEvents.map((event) => (
                <article key={event.id} className="vs-event-card">
                  ...
                  <div className="vs-event-speakers">
                    <span className="vx-muted">{event.speakers?.[0]?.name || "Your Company Name Expert"}</span>
