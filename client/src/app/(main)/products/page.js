...
export const metadata = {
  title: "Products - Your Company Name",
  description: "Explore Your Company Name products and service bundles for business setup, compliance, IP protection, and expert consultation.",
};
    ...
    <>
      <section className="vs-page-hero vx-page-hero">
        <div className="vs-container">
          ...
          <h1>Your Company Name Products and Service Suites</h1>
