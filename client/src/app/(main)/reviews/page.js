  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen">
      {/* ═══════════════════════════════════════════
          1. HERO SECTION
      ═══════════════════════════════════════════ */}
      <section className="relative flex flex-col justify-center overflow-hidden bg-white z-20 px-4 py-20 lg:py-28 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white shadow-sm border-slate-200 border border-slate-200 text-slate-900 text-xs font-black uppercase tracking-widest mb-6 backdrop-blur-sm">
      ...
      {/* ═══════════════════════════════════════════
          2. REVIEWS GRID
      ═══════════════════════════════════════════ */}
      <section className="relative py-16 lg:py-24 -mt-10">
          ...
          {reviews.length === 0 ? (
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {reviews.map((r) => (
                <div 
                  key={r.id} 
                  className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:border-slate-300 transition-all duration-300 relative group flex flex-col h-full"
                >
                  ...
                  <div className="border-t border-slate-100 pt-6 mt-auto relative z-10">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        {r.service && (
                          <p className="text-xs font-semibold text-primary uppercase tracking-wider mt-0.5">{r.service}</p>
                        )}
                        {r.location && (
      ...
      {/* ═══════════════════════════════════════════
          3. CTA SECTION
      ═══════════════════════════════════════════ */}
      <section className="py-16 bg-white border-t border-slate-200/60 text-center px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 text-sm font-bold uppercase tracking-wider text-white bg-primary hover:bg-primary-600 rounded-xl shadow-lg shadow-blue-500/30 transition-all hover:-translate-y-1">
            Talk to an Expert
          </Link>
        </div>
      </section>
