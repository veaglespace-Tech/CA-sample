    ...
    <div className="bg-[#f8fafc] min-h-screen pb-20">
      ...
      <section className="relative -mt-8 z-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
              ...
              <div className="mb-8">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <label className={`relative flex items-center justify-center gap-2 p-4 rounded-2xl border-2 cursor-pointer transition-all ${calcType === "add" ? "border-blue-500 bg-blue-50 text-blue-700" : "border-slate-200 text-slate-600 hover:bg-slate-50"}`}>
                    ...
                    {calcType === "add" && <span className="absolute top-2 right-2 flex h-3 w-3"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span><span className="relative inline-flex rounded-full h-3 w-3 bg-blue-500"></span></span>}
                  </label>
                  <label className={`relative flex items-center justify-center gap-2 p-4 rounded-2xl border-2 cursor-pointer transition-all ${calcType === "remove" ? "border-blue-500 bg-blue-50 text-blue-700" : "border-slate-200 text-slate-600 hover:bg-slate-50"}`}>
                    ...
                    {calcType === "remove" && <span className="absolute top-2 right-2 flex h-3 w-3"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span><span className="relative inline-flex rounded-full h-3 w-3 bg-blue-500"></span></span>}
                  </label>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
                  {[0.25, 3, 5, 12, 18, 28].map(rate => (
                    <button 
                      key={rate}
                      className={`py-3 px-2 rounded-xl border-2 font-bold transition-all ${gstRate === rate ? "border-blue-500 bg-blue-50 text-blue-700 shadow-md shadow-blue-500/10" : "border-slate-200 text-slate-600 hover:bg-slate-50 hover:border-slate-300"}`}
            ...
            {/* Results */}
            <div className="relative rounded-3xl bg-gradient-to-br from-slate-900 to-indigo-950 p-8 text-white shadow-2xl overflow-hidden h-fit">
      ...
      <section className="mt-16 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-sm border border-slate-200">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-between gap-6 p-6 sm:p-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-100">
            <div>
            ...
            <Link href="/gst-registration" className="shrink-0 flex items-center gap-2 bg-blue-600 text-white px-6 py-3.5 rounded-xl font-bold hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/30 transition-all active:scale-95">
