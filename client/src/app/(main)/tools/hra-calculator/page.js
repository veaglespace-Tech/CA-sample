      ...
      <section className="relative -mt-8 z-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
              ...
              <div className="mb-8">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <label className={`relative flex items-center justify-center gap-3 p-4 rounded-2xl border-2 cursor-pointer transition-all ${isMetro ? "border-violet-500 bg-violet-50 text-violet-700" : "border-slate-200 text-slate-600 hover:bg-slate-50"}`}>
              ...
              <div className="grid sm:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="number" 
                      className="w-full pl-12 pr-6 py-4 bg-slate-50 border-2 border-slate-200 rounded-2xl outline-none transition-all text-xl font-black text-slate-900 focus:bg-white focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10" 
                      value={basicSalary} 
            ...
            {/* Results */}
            <div className="relative rounded-3xl bg-gradient-to-br from-violet-700 to-purple-900 p-8 text-white shadow-2xl overflow-hidden h-fit">
              ...
              <div className="relative z-10">
                ...
                <div className="bg-gradient-to-r from-violet-600 to-fuchsia-600 p-5 rounded-2xl shadow-lg border border-violet-400/30 relative overflow-hidden mb-6">
                ...
                <p className="text-center text-xs font-semibold text-violet-200 mt-6 opacity-80 bg-black/20 p-3 rounded-xl backdrop-blur-sm">
