        ...
        <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-3xl space-y-4 text-left">
            ...
            <p className="max-w-2xl text-base font-medium leading-8 text-slate-600 md:text-lg">
              Welcome back to your Your Company Name client portal. Track your application status, view dynamic progress maps, and securely upload verification documents.
            </p>
          </div>
