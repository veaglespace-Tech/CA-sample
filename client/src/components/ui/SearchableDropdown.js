...
export default function SearchableDropdown({
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute z-50 w-full mt-2 bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.15)] border border-slate-100 overflow-hidden transform opacity-100 scale-100 transition-all duration-200">
