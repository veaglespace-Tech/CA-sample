...
import { Gift, Sparkles, ChevronRight, MessageCircle, X } from "lucide-react";
...
function WhatsAppIcon({ size = 17, className = "", ...props }) {
  return (
    <svg
      width={size}
      height={size}
...
const socialLinks = [
  ...
  },
  {
    ...
    bg: "bg-gradient-to-b from-[#f09433] via-[#dc2743] to-[#bc1888]",
  },
  {
    id: "linkedin",
...
export default function FloatingWidgets() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // If within 100px of the bottom, hide the widget
