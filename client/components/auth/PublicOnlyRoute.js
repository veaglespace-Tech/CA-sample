    ...
    <>
      ...
      {(isLoading || user) && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-50/80 backdrop-blur-sm">
          <div className="flex flex-col items-center gap-4 rounded-2xl border border-slate-100 bg-white px-8 py-6 shadow-2xl transition-all duration-400 animate-in fade-in zoom-in hover:-translate-y-1.5 hover:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.3),0_0_20px_rgba(210,144,82,0.1)] hover:border-gold/50">
            <BrandLogo height={38} className="justify-center" />
